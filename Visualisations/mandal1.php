<?php
	...
	$sql1="SELECT * FROM `socio_demographic` WHERE child_id<20000000000 and child_id>10000000000;";
	...
	$sql2="SELECT * FROM `eye` WHERE child_id<20000000000 and child_id>10000000000;";
	...
	$sql3="SELECT * FROM `ent` WHERE child_id<20000000000 and child_id>10000000000;";
	...
	$sql4="SELECT * FROM `skin` WHERE child_id<20000000000 and child_id>10000000000;";
